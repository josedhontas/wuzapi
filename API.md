...
Example sending a new message with a custom preview image in base64
```
curl -X POST -H 'Token: 1234ABCD' -H 'Content-Type: application/json' --data '{"Phone":"5491155554444","Body":"Check my site? https://example.com", "PreviewImage":"data:image/jpeg;base64,/9j/4AAQSk..."}' http://localhost:8080/chat/send/text
```
